import{b5 as o,r as x,j as e,I as c,w as d,A as u,L as m,x as p}from"./index-DP279NKh.js";function f(){const{data:s,isLoading:n,isError:l}=o(),i=x();if(n)return h();if(l)return g();const t=s?.services||[];return t.length?e.jsxs("section",{id:"services",className:`\r
        ...
        bg-indigo-500/5 rounded-full blur-3xl`}),e.jsxs("div",{className:"relative max-w-7xl mx-auto px-6 lg:px-8",children:[e.jsxs("div",{className:"text-center mb-20",children:[e.jsx("span",{className:`\r
            ...
            `,children:"What We Do"}),e.jsxs("h2",{className:"text-4xl sm:text-5xl font-extrabold mt-5 text-[#0B1220]",children:["Smart Solutions for"," ",e.jsx("span",{className:"text-blue-600",children:"Modern Business"})]}),e.jsx("p",{className:"text-gray-600 max-w-2xl mx-auto mt-4 text-lg",children:"Proven IT expertise that helps organizations achieve digital excellence and long-term growth."})]}),e.jsx("div",{className:"grid sm:grid-cols-2 lg:grid-cols-3 gap-10",children:t.map(r=>{const a=c[r.icon]||d;return e.jsxs("div",{className:`\r
                ...
                `,children:[e.jsx("div",{className:`\r
                    ...
                    transition mb-6\r
                  `,children:e.jsx(a,{size:28})}),e.jsx("h3",{className:`\r
                    text-xl font-bold text-[#0B1220]\r
                    text-center\r
                    group-hover:text-blue-600 transition\r
                  `,children:r.title}),e.jsx("p",{className:"text-gray-600 text-center text-sm mt-3 flex-grow",children:r.description}),e.jsxs("button",{onClick:()=>i(`/superadminservices/${r._id}`),className:`\r
                  ...
                  `,children:["Learn More ",e.jsx(u,{size:18})]})]},r._id)})})]})]}):null}function h(){return e.jsx("section",{className:"py-28 flex justify-center bg-white",children:e.jsx(m,{className:"w-8 h-8 text-blue-600 animate-spin"})})}function g(){return e.jsx("section",{className:"py-28 flex justify-center bg-white",children:e.jsxs("div",{className:"bg-red-50 border border-red-300 rounded-xl px-6 py-4 flex items-center gap-3",children:[e.jsx(p,{className:"text-red-600"}),e.jsx("p",{className:"text-red-700 font-medium",children:"Unable to load services"})]})})}export{f as default};
